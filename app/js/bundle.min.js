...
!function(){var t={initialize:function(){var t=this;t.setUpListeners()},btnResult:$(".result__button_prop"),htmlCodeResultArea:$("#html-code__text"),cssCodeResultArea:$("#css-code__text"),setUpListeners:function(){$("form").on("click",".feedback-block__offer-button",t.submitForm),$(".header-block__order-button").on("click",t.scrollToOrder),$(".header-block__info-button").on("click",t.scrollToDetails),$(".details-block__offer-button").on("click",t.scrollToMarket),$("form").on("keydown","input",t.removeError),$("#inputPhone").on("keypress",t.onlyDigitsValidate),$("#inputPhone").on("paste",t.onlyValidatePaste),$("#inputFIO").on("keypress",t.onlySymbolsValidate),$("#inputFIO").on("paste",t.onlyValidatePaste)},onlySymbolsValidate:function(t){var e=t.charCode,o=$(document).width(),l="";return l=768>o?"top":"left",t.ctrlKey||t.altKey||t.metaKey?void 0:(97>e||e>122)&&(65>e||e>90)&&45!=e&&(1040>e||e>1105)&&1025!=e&&32!=e?($(this).tooltip({trigger:"manual",placement:l,title:"Разрешено вводить только буквы"}).tooltip("show"),!1):void 0},onlyValidatePaste:function(){var t=$(document).width(),e="";return e=768>t?"top":"left",$(this).tooltip({trigger:"manual",placement:e,title:"Вводите символы с клавиатуры вручную"}).tooltip("show"),!1},onlyDigitsValidate:function(t){var e=t.charCode,o=$(document).width(),l="";return l=768>o?"top":"left",t.ctrlKey||t.altKey||t.metaKey||43===e?void 0:48>e||e>57?($(this).tooltip({trigger:"manual",placement:l,title:"Разрешено вводить только цифры"}).tooltip("show"),!1):void 0},removeError:function(){$(this).tooltip("destroy").parents(".form-group").removeClass("has-error")},scrollToMarket:function(t){t.preventDefault();var e=$(".market-block__section").offset().top;$("html, body").animate({scrollTop:e-0},800)},scrollToDetails:function(t){t.preventDefault();var e=$(".details-block").offset().top;$("html, body").animate({scrollTop:e-0},800)},scrollToOrder:function(t){t.preventDefault();var e=$(".feedback-block__background").offset().top;$("html, body").animate({scrollTop:e-0},800)},submitForm:function(e){e.preventDefault();var o=$("form"),l=$(".feedback-block__offer-button");if(t.validateForm(o)===!1)return!1;l.addClass("disabled");var a=o.serialize();$.ajax({url:"contact_form/contact_process.php",type:"POST",data:a}).done(function(t){if("OK"===t){var e="<div class='bg-success'>Спасибо за вашу заявку. Мы обязательно свяжемся с вами, в самое ближайшее время.</div>";$.each($(".form-group input"),function(){$(this).removeClass("has-success").val("")}),$("#valid").html(e)}else $("#valid").html(t)}).always(function(){l.removeClass("disabled")})},validateForm:function(t){var e=t.find("input"),o=!0;return e.tooltip("destroy"),$.each(e,function(t,e){var l=$(e),e=l.val(),a=l.parents(".form-group"),r=a.find("label").text(),i="",n=$(document).width(),s="";"ФИО"!==r&&(r=r.toLowerCase()),i="Введите "+r,s=768>n?"top":"left",0===e.length?(a.addClass("has-error").removeClass("has-success"),l.tooltip({trigger:"manual",placement:s,title:i}).tooltip("show"),o=!1):a.addClass("has-success").removeClass("has-error")}),o}};t.initialize()}();
jQuery(document).ready(function(){$objWindow=$(window),$('div[data-type="background"]').each(function(){var o=$(this);$(window).scroll(function(){var n=-($objWindow.scrollTop()/o.data("speed")),d="100% "+n+"px";o.css({backgroundPosition:d})})})});